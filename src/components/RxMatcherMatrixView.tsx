...
import { SubstituteMatrixItem, AppViewMode } from '../types';
import { 
  ShieldCheck, 
  CheckCircle2, 
  ArrowRight, 
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">
            ...
            <span>•</span>
            <span className="text-amber-700 font-bold bg-amber-100 px-2 py-0.5 rounded">Schedule H1 Drug</span>
          </div>
        ...
        <div className="flex items-center gap-3 bg-[#faf8ff] p-3 rounded-2xl border border-gray-200">
          <div>
            ...
            <div className="text-xl font-black text-gray-800">₹223.50</div>
          </div>
          <div className="h-8 w-px bg-gray-200"></div>
          <div>
            <div className="text-[10px] text-gray-400 uppercase font-bold">DPCO 2026 Ceiling</div>
            <div className="text-sm font-bold text-gray-600">₹224.50</div>
          </div>
        </div>
      </div>
